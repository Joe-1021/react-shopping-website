...
function AdminProducts() {
    ...
    return (
        <div className='p-3'>
            <ProductModal closeProductModal={closeProductModal} getProducts={getProducts} type={type} tempProduct={tempProduct}/>
            <DeleteModal close={closeDeletetModal} text={tempProduct.title} handleDelete={deleteProduct} id={tempProduct.id}/>
