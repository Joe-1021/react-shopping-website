...
function OrderModal({ closeModal, getOrders, tempOrder }) {
    ...
    return (
        <div className='modal fade' tabIndex='-1' id='orderModal' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                        ...
                        <div className='mb-3 row'>
                            ...
                            <div className='col-sm-10'>
                                <textarea
                                    ...
                                    readOnly
                                    className='form-control-plaintext'
                                    defaultValue={tempOrder.message ? `${tempOrder.message}` : '無'}
                                />
                            </div>
                        </div>
                        {tempOrder.products && (
